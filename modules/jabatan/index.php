...
$allowed_columns = ['id', 'nama', 'jabatan'];
...
if (!empty($search)) {
    $query .= " WHERE nama LIKE '%$search%' OR jabatan LIKE '%$search%'";
}
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span>Jabatan</span>
                                            <div class="btn-group">
                                                <a href="?sort=jabatan&order=ASC&search=<?php echo urlencode($search); ?>" class="btn btn-sm btn-outline-light <?php echo ($sort_column == 'jabatan' && $sort_order == 'ASC') ? 'active' : ''; ?>">
                                                    <i class="bi bi-sort-alpha-down"></i>
                                                </a>
                                                <a href="?sort=jabatan&order=DESC&search=<?php echo urlencode($search); ?>" class="btn btn-sm btn-outline-light <?php echo ($sort_column == 'jabatan' && $sort_order == 'DESC') ? 'active' : ''; ?>">
                                                    <i class="bi bi-sort-alpha-up"></i>
                                                </a>
                                            </div>
                                        </div>
