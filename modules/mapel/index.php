                                ...
                                <tr>
                                    ...
                                    <th>
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="btn-group">
                                                <a href="?sort=mapel&order=ASC&search=<?php echo urlencode($search); ?>" class="btn btn-sm btn-outline-light <?php echo ($sort_column == 'mapel' && $sort_order == 'ASC') ? 'active' : ''; ?>">
                                                    <i class="bi bi-sort-alpha-down"></i>
                                                </a>
                                                <a href="?sort=mapel&order=DESC&search=<?php echo urlencode($search); ?>" class="btn btn-sm btn-outline-light <?php echo ($sort_column == 'mapel' && $sort_order == 'DESC') ? 'active' : ''; ?>">
